    ...
    <section class="px-3 space-y-5">
        <section class="flex items-center justify-between ">
            <a href="{{route('admin.my-menu')}}"
               class="border border-black/30 rounded-md  flex items-center justify-center flex-col w-[18%]">
                <div class="p-2">
            ...
            <a href="{{route('admin.chargingTheCapsule.index')}}" class="border border-black/30 rounded-md  flex items-center justify-center flex-col w-[18%]">
                <div class="p-2">
            ...
            <a href="{{route('admin.sale.index')}}" class="border border-black/30 rounded-md  flex items-center justify-center flex-col w-[18%]">
                <div class="p-2">
            ...
            <div class="border border-black/30 rounded-md  flex items-center justify-center flex-col w-[18%]">
                <div class="p-2">
