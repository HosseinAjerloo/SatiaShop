                        ...
                        <div class="flex items-center space-x-4 mt-4 sm:mt-0 space-x-reverse py-1.5 sm:px-2 rounded-md">
                            <div>
                                ...
                                <input type="radio" class="person_type" name="customer_type" value="natural_person"
                                       @if(old('customer_type')=='natural_person') checked="checked" @endif @if($reside->user->customer_type=='natural_person') checked="checked" @endif>
                            </div>
                            <div>
                                <label>حقوقی</label>
                                <input class="person_type" type="radio" name="customer_type" value="juridical_person"
                                       @if(old('customer_type')=='juridical_person') checked="checked" @endif @if($reside->user->customer_type=='juridical_person') checked="checked" @endif>
                            </div>
                        </div>
                    </div>
                        ...
                        <tr class="@if(($key%2)==0) bg-white @else bg-gray-200 @endif">
                            ...
                            <td class="border border-gray-400 text-center p-1">
                                <div
                                    ...
                                    <img src="{{asset('capsule/images/plus.svg')}}" alt=""
                                         class="w-6 cursor-pointer plus">
                                    <input type="number" name="product_amount[{{$resideItem->product->id}}]" min="1"
                            ...
                            <td class="border p-2 text-center flex items-center justify-center">
                                <img src="{{asset('capsule/images/delete.svg')}}" alt=""
                                     class="cursor-pointer mx-auto delete-row w-3 sm:w-auto" onclick="deleteRow(this)" data-id="{{$resideItem->product->id}}">
                            </td>
                        </tr>
                    @endforeach
                @endif
