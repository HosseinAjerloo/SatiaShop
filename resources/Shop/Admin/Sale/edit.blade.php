                ...
                <div class="relative transform overflow-hidden rounded-lg bg-white text-right shadow-xl transition-all duration-300 sm:my-8 sm:w-full sm:max-w-3xl translate-y-4 opacity-0 scale-95"
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        ...
                        <button type="button" onclick="closeModal()"
                            class="mt-3 text-white bg-rose-500 inline-flex w-full justify-center ml-3 rounded-md px-3 py-2 text-sm font-semibold  shadow-sm ring-1 ring-inset ring-gray-300  sm:mt-0 sm:w-auto sm:mr-4">
                            انصراف
                        </button>
                    </div>
                </div>
