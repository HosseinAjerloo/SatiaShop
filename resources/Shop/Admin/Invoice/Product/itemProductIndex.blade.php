        ...
        <article class="border-black space-y-5 py-1.5 rounded-md px-4">
                ...
                <article class="   border-black space-y-5 py-1.5 rounded-md rounded-se-none  rounded-ss-none">
                    @foreach($invoice->invoiceItem  as $key=> $invoiceItem)
                        ...
                        <div
                            class="p-2 h-full @if(($key%2)==0) bg-E9E9E9 @else bg-gray-300 @endif flex-wrap  flex items-center justify-between  divide-x-1 divide-black divide-x-reverse">
                            <div class="w-1/5">
                                <p class="  text-min_sm   h-full flex items-center justify-center text-center  ">
