...
@section('content')
    ...
    <form id="form" class="flex items-center justify-between space-x-reverse space-x-3 px-2 mt-5"
          action="{{route('admin.finance.transaction.index')}}">
        ...
        <div class="border border-black flex items-center py-1.5 px-2 rounded-md">
            <input type="text" placeholder="شماره موبایل کاربر را وارد نمائید ..."
        ...
        <input class="customDate" type="hidden" name="customDate"  id="cu"/>
    </form>
