                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                ...
                                <section class="product-info">
                                    ...
                                    <p class="mb-3 mt-5">
                                        ...
                                        برای ثبت سفارش و تکمیل خرید ابتدا باید وارد سایت شوید و از قسمت تکمیل پروفایل اطلاعات
                        ...
                        <section class="col-md-3">
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                ...
                                <section class="space-y-3">
                                    <div    id="next-level" href="#" class="btn btn-danger d-block addCart  text-min" data-id="{{$product->id}}">
                                    ...
                                    <a id="next-level" href="{{route('panel.cart.index')}}" class="btn btn-danger d-block  text-min">
                                        مشاهده سبد خرید
                                    </a>
                                </section>
