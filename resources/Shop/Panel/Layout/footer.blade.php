...
{{--                        <img src="{{asset("shop/assets/images/footer/1.png")}}" alt="">--}}
{{--                        <section class="text-center">امکان تحویل اکسپرس</section>--}}
{{--                    </section>--}}

{{--                    <section class="footer-shop-features-item">--}}
{{--                        <img src="{{asset("shop/assets/images/footer/2.png")}}" alt="">--}}
{{--                        <section class="text-center">امکان پرداخت در محل</section>--}}
{{--                    </section>--}}

{{--                    <section class="footer-shop-features-item">--}}
{{--                        <img src="{{asset("shop/assets/images/footer/3.png")}}" alt="">--}}
{{--                        <section class="text-center">7 روز هفته، 24 ساعته</section>--}}
{{--                    </section>--}}

{{--                    <section class="footer-shop-features-item">--}}
{{--                        <img src="{{asset("shop/assets/images/footer/4.png")}}" alt="">--}}
{{--                        <section class="text-center">7 روز ضمانت بازگشت کالا</section>--}}
{{--                    </section>--}}

{{--                    <section class="footer-shop-features-item">--}}
{{--                        <img src="{{asset("shop/assets/images/footer/5.png")}}" alt="">--}}
...
{{--            </section>--}}
        ...
        <section class="row border-top pt-4">
            <section class="col">
                <section class="text-muted footer-intro text-center">کلیه حقوق این وبسایت متعلق به شرکت سایتا می باشد.</section>
            </section>
        </section>
    </section>
</footer>
