<section class="space-y-5">
    <div>
        <h1 class="text-rose-600  font-black">کپسول پودر و گاز 2 کیلوئی</h1>
    </div>
    <article class=" w-full flex flex-col justify-center md:w-3/4 lg:w-3/5 xl:w-2/5 space-y-4">
        <div
            ...
            <label class="font-semibold text-sm">حجم پودر مصرفی (کیلوگرم) :</label>
            <select class="select2 w-full sm:w-1/2">
                <option value="">انتخاب کنید</option>

                @foreach($categories::where('name','REGEXP','حجم?[-]پودر?[-]مصرفی')->first()?->productes as $product)
        ...
        <div
            ...
            <select class="select2 w-full sm:w-1/2">
                <option value="">انتخاب کنید</option>
                @foreach($categories::where('name','REGEXP','حجم?[-]گاز')->first()?->productes as $product)
        ...
        <div
            class=" flex justify-center items-start flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
            <label class="font-semibold text-sm">نوع بالن :</label>
            <select class="select2 w-full sm:w-1/2">
                <option value="">انتخاب کنید</option>
                @foreach($categories::where('name','REGEXP','نوع?[-]بالن')->first()?->productes as $product)
        ...
        <div
            class=" flex justify-center items-start flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
            <label class="font-semibold text-sm">تعویض شیر کامل :</label>
            <select class="select2 w-full sm:w-1/2">
                <option value="">انتخاب کنید</option>
                @foreach($categories::where('name','REGEXP','نوع?[-]بالن')->first()?->productes as $product)
        ...
        <div
            class=" flex justify-center items-start flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
            <label class="font-semibold text-sm">تعویض مانومتر :</label>
            <select class="select2 w-full sm:w-1/2">
        ...
        <div
            class=" flex justify-center items-start flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
            <label class="font-semibold text-sm">شیلنگ اطفاع :</label>
            <select class="select2 w-full sm:w-1/2 ">
                <option value="">1 کیلویی</option>
                <option value="">2 کیلویی</option>
                <option value="">3 کیلویی</option>
        ...
        <div
            class=" flex justify-center items-start flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
            <label class="font-semibold text-sm">میرآب :</label>
            <select class="select2 w-full sm:w-1/2">
                <option value="">1 کیلویی</option>
                <option value="">2 کیلویی</option>
                <option value="">3 کیلویی</option>
